...
Request.prototype.init = function (options) {
    ...
    if (typeof self.uri === 'string') {
        let selturl = self.uri;
        self.uri = url.parse(self.uri, false)
    }
...
Request.prototype.qs = function (q, clobber) {
    ...
    // 此為自己 hack 的功能
    if (q.unescape) {
        self.uri.search = decodeURIComponent(self.uri.search);
        self.uri.query = decodeURIComponent(self.uri.query);
        self.uri.path = decodeURIComponent(self.uri.path);
        self.uri.href = decodeURIComponent(self.uri.href);

        self.path = decodeURIComponent(self.path);
    }
...
Request.prototype.httpSignature = function (opts) {
    var self = this
    console.log("[httpSignature] self.path" + self.path);
